...
public class Reader implements Serializable {
    ...
    public String toString() {
        return String.format("%s {%s='%s', %s=%d}", AppLocale.getString(AppLocale.reader), AppLocale.getString(AppLocale.name), name, AppLocale.getString(AppLocale.mobileNumber), mobileNumber);
    }
